        ...
        <div class="p-seek__under" id="lineup">
          ...
          <ul class="p-seek__rowList">
            <li class="p-seek__rowItem <?php if (strpos($url, 'order') == false) { {
                                        ...
                                        } ?>"><a href="<?php echo esc_url(home_url()); ?>/buy/pentax#lineup">新着順</a></li>
            <li class="p-seek__rowItem <?php if (strpos($url, 'DESC') !== false) { {
                                            echo "is-active";
                                          }
                                        } ?>"><a href="<?php echo esc_url(add_query_arg(array('orderby' => 'meta_value_num', 'meta_value' => 'pentax', 'meta_key' => array(array('nomal_price', 'cam_price')), 'order' => 'DESC'))); ?>#lineup">価格が高い順</a></li>
            <li class="p-seek__rowItem <?php if (strpos($url, 'ASC') !== false) { {
                                            echo "is-active";
                                          }
                                        } ?>"><a href="<?php echo esc_url(add_query_arg(array('orderby' => 'meta_value_num', 'meta_value' => 'pentax', 'meta_key' => 'nomal_price', 'order' => 'ASC'))); ?>#lineup">価格が安い順</a></li>
          </ul>
