<div class="p-form__content">
  ...
  <div class="p-form__content">
    ...
    <dl class="radio-button">
      ...
      <dd>[radio radio class:radio-btns__item use_label_element "銀行振り込み"]</dd>
    </dl>
    <dl>
  ...
  <div class="terms-box conf-hide">
    ...
    <div class="p-form__privacybox">
      <dl>
        <dt>個人情報の取り扱いについて</dt>
        <dd>本お買い上げフォームにご提供いただくお客様情報は、弊社の個人情報保護方針(<a href="/privacypolicy/" target="_blank" rel="noopener">https://geomarket.jp/privacypolicy/</a>)に従い厳重に管理すると共に以下の通り取り扱います。
          なお、弊社では、各業務の一部を委託先に委託し、当該委託先に対して必要な範囲で個人情報を委託する場合があります。この場合には、法令および弊社で定めた基準に従って適切な管理を行います。
          <dl>
            <dt>利用目的</dt>
            <dd>買取依頼品の事前査定、買取、本商品の購入をはじめとする本サービスの運営のため / 本サービスに関する利用状況の調査および分析のため / お客様からの問い合わせに対し適切に対応するため /
  ...
  <div class="button-wrap">
    ...
    [multistep multistep-310 first_step "http://localhost:10058/buy/purchase/purchase-confirm/"]
  </div>
</div>