...
[date your-period02 id:your-period02 show_error:false]
      <p id="check" class="check">[checkbox checkperiod use_label_element id:checkperiod class:checkbox__item "レンタル期間が未定"]<span>の場合はチェックを入れてください。</span>
</p>
    </dd>
  </dl>
  <dl>
    ...
    <dd class="checkbox">
      <div class="check-block">
        ...
        トータルステーション
        <div>
[checkbox checkbox use_label_element id:checkbox class:checkbox__item "アルミ三脚" "ピンポールプリズムセット" "自動追尾用 220°プリズムセット" "自動追尾用360°プリズムセット"]
      ...
      <div class="check-block">
        ...
        GNSS
        <div>
[checkbox checkbox02 use_label_element  id:checkbox02 class:checkbox__item "VRS観測セット（ポール、二脚スタンド、コントローラー用機器）" "ピンポールプリズムセット" "自動追尾用 220°プリズムセット" "自動追尾用360°プリズムセット"]
      ...
      <div class="check-block">
        ...
        3Dスキャナ
        <div>[checkbox checkbox03 use_label_element id:checkbox03 class:checkbox__item "RTC用三脚" "RTC用バックパック" "6インチターゲット" "ターゲット用バック" "固定式ポール/ターゲット用三脚/三脚用バック" "解析用PC"]
...
[multistep multistep-836 first_step "https://geomarket.staging-square.com/rental/contact/confirm/"]