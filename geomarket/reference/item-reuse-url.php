<div class="p-form__content">
  ...
  <dl class="file">
    <dt><label for="your-image">写真</label></dt>

    <dd>
      <div class="upload-box">
        <div class="upload-boxInner conf-border">
          <label>[mfile your-image limit:10485760 filetypes:jpg|jpeg|png|gif min-file:1 class:upload-1 id:aaaaaa]</label>
        </div>
      </div>
      <p class="note">【ご注意ください】添付画像は10MBまでとしてください。なお、添付画像が複数ある場合は、お手数ですが、zipフォルダで圧縮し、添付してください。</p>
    </dd>
  </dl>
...
[checkbox your-know id:your-know class:checkbox__item use_label_element "Yahoo!又はGoogle検索" "インターネット広告(バナー広告)" "ウェビナー" "メールマガジン" "調査士会会報" "ご紹介" "SNS(Facebook・Instagram・X)" ]
  ...
  <div class="terms-box conf-hide">
    ...
    <div class="p-form__privacybox">
      <dl>
        <dt>個人情報の取り扱いについて</dt>
        <dd>各種お問い合わせフォームよりご提供いただくお客様情報は、弊社の個人情報保護方針(<a href="/privacypolicy/" target="_blank" rel="noopener">https://geomarket.jp/privacypolicy/</a>)に従い厳重に管理すると共に以下の通り取り扱います。
          なお、弊社では、各業務の一部を委託先に委託し、当該委託先に対して必要な範囲で個人情報を委託する場合があります。この場合には、法令および弊社で定めた基準に従って適切な管理を行います。
          <dl>
            <dt>利用目的</dt>
            <dd>買取依頼品の事前査定、買取、商品の購入、レンタル、修理点検をはじめとする各サービスの運営のため / 本サービスに関する利用状況の調査および分析のため / お客様からの問い合わせに対し適切に対応するため /
              その他秋測個人情報保護方針ならびに前記各目的に密接に関連する目的のため</dd>
          </dl>
          <dl>
            <dt>第三者提供</dt>
            <dd>弊社との間で個人情報保護に関する約定をしている委託先等のビジネスパートナーに提供する場合があります。 / 本サービスに関する利用状況の調査および分析のため /
              お客様からの問い合わせに対し適切に対応するため / その他秋測個人情報保護方針ならびに前記各目的に密接に関連する目的のため</dd>
          </dl>
          <dl>
            <dt>連絡先</dt>
            <dd>個人情報お問合せ窓口
              ...
              <ul>
                ...
                <li>・当ホームページ(<a href="/privacypolicy/" target="_blank" rel="noopener">https://geomarket.jp/privacypolicy/</a>)に、最新のお客様の個人情報の取り扱いや弊社の案内を掲示いたしておりますのでこちらを定期的にご確認いただきますようお願いいたします。</li>
              </ul>
            </dd>
          </dl>
        </dd>
...
[multistep multistep-472 first_step "https://geomarket.staging-square.com/reuse/assessment-2/confirm/"]