<div class="p-form">
  <div class="p-form__content">
    <dl>
      ...
      <dd>[text id="your-company" your-company]</dd>
    </dl>
    <dl>
      <dt><label for="your-company">ご担当者様の役職</label></dt>
      <dd>[text id="your-position" your-position]</dd>
    </dl>
    <dl>
    ...
    <dl>
      ...
      <dd>[text*  id="your-kana" your-kana]</dd>
    </dl>
    ...
    <div class="terms-box conf-hide">
      ...
      <div class="p-form__privacybox">
        <dl>
          <dt>個人情報の取り扱いについて</dt>
          <dd>
            本お買い上げフォームにご提供いただくお客様情報は、弊社の個人情報保護方針(<a href="/privacypolicy/" target="_blank" rel="noopener">https://geomarket.staging-square.com/privacypolicy/</a>)に従い厳重に管理すると共に以下の通り取り扱います。
            ...
            <dl>
              ...
              <dd>
                ...
                <ul>
                  ...
                  <li>
                    ・当ホームページ(<a href="/privacypolicy/" target="_blank" rel="noopener">https://geomarket.staging-square.com/privacypolicy/</a>)に、最新のお客様の個人情報の取り扱いや弊社の案内を掲示いたしておりますのでこちらを定期的にご確認いただきますようお願いいたします。
                  </li>
                </ul>
              </dd>
            </dl>
