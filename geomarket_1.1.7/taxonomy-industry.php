      ...
      <div class="l-container">
        ...
        <div class="p-seek__under" id="lineup">
          <h2 class="c-heading -main buy-title">
            ...
            <span class="u-fill__name">
              <?php // URLパラメータからフィルターを取得
                echo "[$taxonomy_name]"; 
              ?>                  
            </span>
          </h2>
          <ul class="p-seek__rowList">
            <li class="p-seek__rowItem <?php if (strpos($url, 'order') == false) { {
                                        ...
                                        } ?>"><a href="<?php echo esc_url(home_url()); ?>/buy/industry/<?php echo $taxonomy_slug ?>#lineup">新着順</a></li>
              ...
              $args = array(
                ...
                'tax_query' => array(
                  array(
                    ...
                    'field' => 'slug',
                    'terms' =>  $taxonomy_slug, //取得したタームが入る ,//タームを指定
