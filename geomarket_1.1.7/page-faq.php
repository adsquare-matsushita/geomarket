      ...
      <div class="l-container -sizeS">
        ...
        <div class="js_tab">
          ...
          <ul class="p-news__cat js_tab_btn">
            <li class="p-news__catItem is-tab"><span>購入</span></li>
            <li class="p-news__catItem"><span>買取</span></li>
            <li class="p-news__catItem"><span>レンタル</span></li>
            <li class="p-news__catItem"><span>修理・点検</span></li>
          ...
          <div class="js_tab_content">
            ...
            <div class="p-faq -sub">
              ...
              <dl class="js-accordion">
                <dt><span>転倒や冠水して、動作しなくなった測量機器でも買取りは可能でしょうか？</span></dt>
                <dd><span>はい、可能です。<br>
                  他社で断られた場合でも、ジオマーケットでは最大限評価させていただいておりますので、諦めて処分される前にまずはご相談ください。
                  </span>
                </dd>
              </dl>
